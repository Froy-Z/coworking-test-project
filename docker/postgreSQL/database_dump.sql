...
--
-- Data for Name: coworking; Type: TABLE DATA; Schema: public; Owner: root
--

COPY public.coworking (id, name) FROM stdin;
1	Мозговой штурм
2	Необычный экипаж
3	Нулевой километр
...
COPY public.reservation (id, end_booking, start_booking, room_id) FROM stdin;
...
COPY public.room (id, work_spaces, coworking_id) FROM stdin;
1	2	1
2	5	1
3	14	1
4	18	1
